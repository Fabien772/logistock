 ...
 */
final class Version20250408193530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, marque VARCHAR(255) NOT NULL, immat VARCHAR(255) NOT NULL, modele VARCHAR(255) NOT NULL, date_aquisition DATE DEFAULT NULL, attribution VARCHAR(255) DEFAULT NULL, numero_place INT DEFAULT NULL, equipement_police TINYINT(1) NOT NULL, pret TINYINT(1) NOT NULL, situation VARCHAR(255) DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
